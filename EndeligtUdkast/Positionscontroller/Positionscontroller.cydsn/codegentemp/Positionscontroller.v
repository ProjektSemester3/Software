// ======================================================================
// Positionscontroller.v generated from TopDesign.cysch
// 12/19/2016 at 18:54
...
module top ;
	...
	wire [0:0] tmpOE__Pin_int_x_end_net;
	wire [0:0] tmpIO_0__Pin_int_x_end_net;
	electrical [0:0] tmpSIOVREF__Pin_int_x_end_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3f1098c8-a31a-4684-b21e-79f2ec2425db"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_int_x_end
		 (.oe(tmpOE__Pin_int_x_end_net),
		  .y({1'b0}),
		  .fb({Net_6}),
		  .io({tmpIO_0__Pin_int_x_end_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_int_x_end_net),
		  .interrupt({Net_9411}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_int_x_end_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_int_y_end_net;
	wire [0:0] tmpIO_0__Pin_int_y_end_net;
	electrical [0:0] tmpSIOVREF__Pin_int_y_end_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("99ca3f2a-2b5e-4d35-a251-1482e34b8a0a"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_int_y_end
		 (.oe(tmpOE__Pin_int_y_end_net),
		  .y({1'b0}),
		  .fb({Net_7}),
		  .io({tmpIO_0__Pin_int_y_end_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_int_y_end_net),
		  .interrupt({Net_2557}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_int_y_end_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    SPI_Master_v2_50_6 SPIM_1 (
        ...
        .clock(1'b0),
        .reset(1'b0),
        .rx_interrupt(Net_230),
        .sdat(Net_231),
        .tx_interrupt(Net_232));
