...
/* Interrupt Registers */
	...
	#define MotorOut_1_INTTYPE_REG 		(* (reg8 *) MotorOut__1__INTTYPE)
	#define MotorOut_2_INTTYPE_REG 		(* (reg8 *) MotorOut__2__INTTYPE)
	#define MotorOut_3_INTTYPE_REG 		(* (reg8 *) MotorOut__3__INTTYPE)
#endif /* (MotorOut__INTSTAT) */
