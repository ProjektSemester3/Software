// ======================================================================
// SlaveTop.v generated from TopDesign.cysch
// 11/24/2016 at 18:02
...
module top ;
	...
	wire [3:0] tmpOE__MotorOut_1_net;
	wire [3:0] tmpFB_3__MotorOut_1_net;
	wire [3:0] tmpIO_3__MotorOut_1_net;
	wire [0:0] tmpINTERRUPT_0__MotorOut_1_net;
	electrical [0:0] tmpSIOVREF__MotorOut_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("6ca57954-d03b-433c-8d42-2f07595a070a"),
		  ...
		  .input_buffer_sel(8'b00_00_00_00))
		MotorOut_1
		 (.oe(tmpOE__MotorOut_1_net),
		  .y({Net_654, Net_653, Net_652, Net_650}),
		  .fb({tmpFB_3__MotorOut_1_net[3:0]}),
		  .io({tmpIO_3__MotorOut_1_net[3:0]}),
		  .siovref(tmpSIOVREF__MotorOut_1_net),
		  .interrupt({tmpINTERRUPT_0__MotorOut_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorOut_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};
    ...
    begin : LUT_1
        ...
        assign tmp__LUT_1_ins = {Net_651,Net_1237};
        always @(tmp__LUT_1_ins)
        begin
            case (tmp__LUT_1_ins)
                2'b00 :  tmp__LUT_1_reg = 4'b1010;
                2'b01 :  tmp__LUT_1_reg = 4'b1001;
                2'b10 :  tmp__LUT_1_reg = 4'b0101;
                2'b11 :  tmp__LUT_1_reg = 4'b0110;
            endcase
        end
        assign {Net_654,Net_653,Net_652,Net_650} = tmp__LUT_1_reg;
    end
    // -- LUT LUT_1 end --

    CyControlReg_v1_80 stepindex_1 (
        .control_1(Net_361),
        .control_2(Net_362),
        .control_3(Net_363),
        .control_0(Net_651),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam stepindex_1.Bit0Mode = 0;
    defparam stepindex_1.Bit1Mode = 0;
    defparam stepindex_1.Bit2Mode = 0;
    defparam stepindex_1.Bit3Mode = 0;
    defparam stepindex_1.Bit4Mode = 0;
    defparam stepindex_1.Bit5Mode = 0;
    defparam stepindex_1.Bit6Mode = 0;
    defparam stepindex_1.Bit7Mode = 0;
    defparam stepindex_1.BitValue = 0;
    defparam stepindex_1.BusDisplay = 0;
    defparam stepindex_1.ExtrReset = 0;
    defparam stepindex_1.NumOutputs = 1;
	...
	cy_clock_v1_0
		#(.id("a0af0223-eea3-4a29-a6e9-daa80727c299"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("11904761904.7619"),
		  .is_direct(0),
	...
	wire [3:0] tmpOE__MotorOut_2_net;
	wire [3:0] tmpFB_3__MotorOut_2_net;
	wire [3:0] tmpIO_3__MotorOut_2_net;
	wire [0:0] tmpINTERRUPT_0__MotorOut_2_net;
	electrical [0:0] tmpSIOVREF__MotorOut_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b4c22572-7ebc-4d66-955e-56141a08c4e6"),
		  ...
		  .input_buffer_sel(8'b00_00_00_00))
		MotorOut_2
		 (.oe(tmpOE__MotorOut_2_net),
		  .y({Net_1563, Net_1562, Net_1561, Net_1559}),
		  .fb({tmpFB_3__MotorOut_2_net[3:0]}),
		  .io({tmpIO_3__MotorOut_2_net[3:0]}),
		  .siovref(tmpSIOVREF__MotorOut_2_net),
		  .interrupt({tmpINTERRUPT_0__MotorOut_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorOut_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};

    // -- LUT LUT_2 start --
    if (1)
    begin : LUT_2
        reg [3:0] tmp__LUT_2_reg;
        wire [1:0] tmp__LUT_2_ins;
        assign tmp__LUT_2_ins = {Net_1560,Net_1174};
        always @(tmp__LUT_2_ins)
        begin
            case (tmp__LUT_2_ins)
                2'b00 :  tmp__LUT_2_reg = 4'b1010;
                2'b01 :  tmp__LUT_2_reg = 4'b1001;
                2'b10 :  tmp__LUT_2_reg = 4'b0101;
                2'b11 :  tmp__LUT_2_reg = 4'b0110;
            endcase
        end
        assign {Net_1563,Net_1562,Net_1561,Net_1559} = tmp__LUT_2_reg;
    end
    // -- LUT LUT_2 end --

    CyControlReg_v1_80 stepindex_2 (
        .control_1(Net_559),
        .control_2(Net_560),
        .control_3(Net_561),
        .control_0(Net_1560),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam stepindex_2.Bit0Mode = 0;
    defparam stepindex_2.Bit1Mode = 0;
    defparam stepindex_2.Bit2Mode = 0;
    defparam stepindex_2.Bit3Mode = 0;
    defparam stepindex_2.Bit4Mode = 0;
    defparam stepindex_2.Bit5Mode = 0;
    defparam stepindex_2.Bit6Mode = 0;
    defparam stepindex_2.Bit7Mode = 0;
    defparam stepindex_2.BitValue = 0;
    defparam stepindex_2.BusDisplay = 0;
    defparam stepindex_2.ExtrReset = 0;
    defparam stepindex_2.NumOutputs = 1;
