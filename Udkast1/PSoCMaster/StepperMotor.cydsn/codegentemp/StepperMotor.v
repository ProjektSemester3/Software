...
module SPI_Master_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("d4dffd60-ed32-464a-8836-fe9ff80ac2cb/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("500000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("82bcba54-a18d-44cd-9fc7-ac03b08d079d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6134bc21-ffcb-466e-ab87-9c1d3f4a8b2d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__SS_XY_net;
	wire [0:0] tmpFB_0__SS_XY_net;
	wire [0:0] tmpIO_0__SS_XY_net;
	wire [0:0] tmpINTERRUPT_0__SS_XY_net;
	electrical [0:0] tmpSIOVREF__SS_XY_net;

	cy_psoc3_pins_v1_10
		#(.id("8025111d-3e9e-4aa9-9b49-3b067acc3d99"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SS_XY
		 (.oe(tmpOE__SS_XY_net),
		  .y({Net_262}),
		  .fb({tmpFB_0__SS_XY_net[0:0]}),
		  .io({tmpIO_0__SS_XY_net[0:0]}),
		  .siovref(tmpSIOVREF__SS_XY_net),
		  .interrupt({tmpINTERRUPT_0__SS_XY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SS_XY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SS_Z_net;
	wire [0:0] tmpFB_0__SS_Z_net;
	wire [0:0] tmpIO_0__SS_Z_net;
	wire [0:0] tmpINTERRUPT_0__SS_Z_net;
	electrical [0:0] tmpSIOVREF__SS_Z_net;

	cy_psoc3_pins_v1_10
		#(.id("ac9fba92-827e-4cd8-a5a6-8a2569a056ea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SS_Z
		 (.oe(tmpOE__SS_Z_net),
		  .y({Net_259}),
		  .fb({tmpFB_0__SS_Z_net[0:0]}),
		  .io({tmpIO_0__SS_Z_net[0:0]}),
		  .siovref(tmpSIOVREF__SS_Z_net),
		  .interrupt({tmpINTERRUPT_0__SS_Z_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SS_Z_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
