...
module top ;
	...
	wire [7:0] tmpOE__Coils_1_net;
	wire [7:0] tmpFB_7__Coils_1_net;
	wire [7:0] tmpIO_7__Coils_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Coils_1
		 (.oe(tmpOE__Coils_1_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__Coils_1_net[7:0]}),
		  .io({tmpIO_7__Coils_1_net[7:0]}),
	...
	assign tmpOE__Coils_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
