...
module top ;
	...
	wire [3:0] tmpOE__Coils_Y_net;
	wire [3:0] tmpFB_3__Coils_Y_net;
	wire [3:0] tmpIO_3__Coils_Y_net;
	wire [0:0] tmpINTERRUPT_0__Coils_Y_net;
	electrical [0:0] tmpSIOVREF__Coils_Y_net;
	...
	cy_psoc3_pins_v1_10
		...
		Coils_Y
		 (.oe(tmpOE__Coils_Y_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__Coils_Y_net[3:0]}),
		  .io({tmpIO_3__Coils_Y_net[3:0]}),
		  .siovref(tmpSIOVREF__Coils_Y_net),
		  .interrupt({tmpINTERRUPT_0__Coils_Y_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Coils_Y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};

    ADC_SAR_SEQ_v2_0_2 ADC_SAR_Seq (
        .soc(1'b0),
        .aclk(1'b0),
        .sdone(Net_16),
        .eoc(Net_17),
	...
	wire [3:0] tmpOE__Coils_X_net;
	wire [3:0] tmpFB_3__Coils_X_net;
	wire [3:0] tmpIO_3__Coils_X_net;
	wire [0:0] tmpINTERRUPT_0__Coils_X_net;
	electrical [0:0] tmpSIOVREF__Coils_X_net;

	cy_psoc3_pins_v1_10
		#(.id("90de6f05-cf7d-4e7e-b389-e7673566a6b5"),
		  .drive_mode(12'b110_110_110_110),
		  .ibuf_enabled(4'b1_1_1_1),
		  .init_dr_st(4'b0_0_0_0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(8'b00_00_00_00))
		Coils_X
		 (.oe(tmpOE__Coils_X_net),
		  .y({4'b0}),
		  .fb({tmpFB_3__Coils_X_net[3:0]}),
		  .io({tmpIO_3__Coils_X_net[3:0]}),
		  .siovref(tmpSIOVREF__Coils_X_net),
		  .interrupt({tmpINTERRUPT_0__Coils_X_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Coils_X_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{4'b1111} : {4'b1111};

	wire [0:0] tmpOE__Pin_int_x_net;
	wire [0:0] tmpIO_0__Pin_int_x_net;
	electrical [0:0] tmpSIOVREF__Pin_int_x_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_int_x
		 (.oe(tmpOE__Pin_int_x_net),
		  .y({1'b0}),
		  .fb({Net_215}),
		  .io({tmpIO_0__Pin_int_x_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_int_x_net),
		  .interrupt({Net_217}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_int_x_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_int_y_net;
	wire [0:0] tmpIO_0__Pin_int_y_net;
	electrical [0:0] tmpSIOVREF__Pin_int_y_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("63c671f2-588e-4b1c-b61a-c0fd88a7d3ed"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_int_y
		 (.oe(tmpOE__Pin_int_y_net),
		  .y({1'b0}),
		  .fb({Net_216}),
		  .io({tmpIO_0__Pin_int_y_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_int_y_net),
		  .interrupt({Net_218}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_int_y_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
